...
export default function ExamPortal() {
    ...
    const handleSubjectChange = (subject, index) => {
        ...
        firstQuestion = QuestionPaperObject.paper[index];
        console.log("firstQuestion1gdgsjh :",firstQuestion)
    ...
    const currentQuestion2=firstQuestion;
    // console.log("currentQuestion",currentQuestion.questions[0].Question);
    
    console.log("currentQuestion2 : ",currentQuestion2.questions[0].Question);
                                ...
                                <div className="col-12 ">
                                    <div className="card">
                                        ...
                                        <div className="card-body p-5 " id="background-img">
                                            ...
                                            <h4 className="card-text">{`Q${currentQuestionIndex + 1}. ${currentQuestion2.questions[count].Question}`}</h4>
                                            <div className="form-check mt-4 ms-5">
                                                <input className="form-check-input" type="radio" name="mcqOptions" id="option1" value="option1" />
                                                <label className="form-check-label" for="option1">{`A) ${currentQuestion2.questions[count].OptionA}`}</label>
                                            </div>
                                            <div className="form-check mt-4 ms-5">
                                                <input className="form-check-input" type="radio" name="mcqOptions" id="option2" value="option2" />
                                                <label className="form-check-label" for="option2">{`B) ${currentQuestion2.questions[count].OptionB}`}</label>
                                            </div>
                                            <div className="form-check mt-4 ms-5">
                                                <input className="form-check-input" type="radio" name="mcqOptions" id="option3" value="option3" />
                                                <label className="form-check-label" for="option3">{`C) ${currentQuestion2.questions[count].OptionC}`}</label>
                                            </div>
                                            <div className="form-check mt-4 ms-5">
                                                <input className="form-check-input" type="radio" name="mcqOptions" id="option4" value="option4" />
                                                <label className="form-check-label" for="option4">{`D) ${currentQuestion2.questions[count].OptionD}`}</label>
                                            </div>
                                        </div>
