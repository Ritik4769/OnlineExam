...
function UpdateBatchModal(props) {
    ...
    function addBatch(e) {
        ...
        formData.append("_id", batch._id);
        try {
            console.log("formData",formData);
            // if (batchname && trainername && center) {
                axios.post(`http://localhost:3002/admin/updateBatch`, formData).then((result) => {
                    if (result.data.status == "Batch Updated Sucessfully!!!!") {
                    ...
                    setMessageObj({ message: "Error While Updating Batch", class: "alert alert-danger", icon: <i className="bi bi-dash-circle"></i> })
                    console.log('', error);
                })
            // }
            //  else {
                    ...
                    <ModalBody>
                        ...
                        <div className="form-floating mb-3">
                            <select className="form-control"
                                ...
                                defaultValue={batch.trainerName}
                                name="trainerName"
                                id='trainerName'>
                        ...
                        <div className=" mb-3">
                            ...
                            <select className="batchCenter form-control" defaultValue={batch.batchCenter} onChange={(e) => { getBatchdata(e); }} name="batchCenter">
