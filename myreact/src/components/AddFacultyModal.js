...
function AddFacultyModal(props) {
    ...
    var Name = false, Email = false, Number = false, linkedid = false, joindate = false, department = false, facultyimg = false;
                ...
                <form onSubmit={addFaculty} enctype="multipart/form-data" >
                    ...
                    <ModalBody>
                        ...
                        <div className="form-floating mb-3">
                            ...
                            <label htmlFor="facultyname" > <i className="bi bi-person-circle"></i> &nbsp; Faculty Name</label>
                        </div>
                        <p id='name'></p>
                        <div className="form-floating mb-3">
                        ...
                        <div className="form-floating mb-3">
                            ...
                            <label htmlFor="joiningDate"><i className="bi bi-calendar-date"></i>&nbsp;Joining Date</label>
                        </div>
                        <p id='date'></p>
                        <div className=" mb-3">
                        ...
                        <div className="form-floating mb-3">
                            ...
                            <label htmlFor="floatingInput"><i className="bi bi-calendar-date"></i>&nbsp;Add Technologiie Skills | Separate with commas  </label>
                        </div>
                    </ModalBody>
                    <ModalFooter>
