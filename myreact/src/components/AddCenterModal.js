                ...
                <form onSubmit={addCenter} encType="multipart/form-data">
                    ...
                    <ModalBody>
                            ...
                            >
                                <option value="NULL">Select Manager</option>                               
                                {
                                    Managers.map((Manager)=>{
                                        return <option value={Manager.facultyname}>{Manager.facultyname}</option>
                                    })
                                }                                
                            </select>
                        ...
                        <div class="form-floating mb-3">
                          <textarea required class="form-control" placeholder="Leave a comment here" id="address" 
                           name="address"
                           onChange={(e) => {
                            getCenterdata(e);
                           }}                       
                          ></textarea>
                          <label for="address"> <i class="bi bi-geo-fill"></i> Center Address</label>
                        </div>
                        <p id="add"></p>
